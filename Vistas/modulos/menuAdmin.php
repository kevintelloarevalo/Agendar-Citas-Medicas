<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>  <!----para la lista---->
          <a href="secretarias">  <!--ancor para la ruta-->
            <i class="fa fa-heart"></i>  <!--para el icono-->
            <span>Secretarias</span>  <!--Texto-->
          </a>
        </li>
      ...
      <ul class="sidebar-menu">
        ...
        <li>  <!----para la lista---->
          <a href="configuracion">  <!--ancor para la ruta-->
            <i class="fa fa-cogs"></i>  <!--para el icono-->
            <span>Configuración</span>  <!--Texto-->
          </a>
        </li>
